...
//   const industriesData = [
//     { name: "Healthcare", svg: <YourHealthcareSvgComponent /> },
//     { name: "Finance", svg: <YourFinanceSvgComponent /> },
//     { name: "Education", svg: <YourEducationSvgComponent /> },
//     { name: "Real Estate", svg: <YourRealEstateSvgComponent /> },
//     { name: "Manufacturing", svg: <YourManufacturingSvgComponent /> },
//     { name: "Transportation", svg: <YourTransportationSvgComponent /> },
//     { name: "Logistics", svg: <YourLogisticsSvgComponent /> },
//     { name: "Media", svg: <YourMediaSvgComponent /> },
//     { name: "Entertainment", svg: <YourEntertainmentSvgComponent /> },
//     { name: "Non-Profit", svg: <YourNonProfitSvgComponent /> },
//   ];
